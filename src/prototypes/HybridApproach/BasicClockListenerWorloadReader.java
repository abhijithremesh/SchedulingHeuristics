...
public class BasicClockListenerWorloadReader {
    ...
    public static void main(String[] args) throws Exception {
        new BasicClockListenerWorloadReader();
    }

    private BasicClockListenerWorloadReader()  {
    ...
    public void pauseSimulationAtSpecificTime(EventInfo eInfo) {
        ...
        if (Math.round(simulation.clock()) == INTERVAL * heuristicIndex) {
            simulation.pause();
