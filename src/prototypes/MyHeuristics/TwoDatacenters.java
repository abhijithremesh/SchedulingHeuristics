...
public class TwoDatacenters {
    ...
    private TwoDatacenters() {
        ...
        System.out.println("datacenter0 hosts");
        datacenter0.getHostList().forEach(h-> System.out.println(h.getId()));
        System.out.println("datacenter1 hosts");
        datacenter1.getHostList().forEach(h-> System.out.println(h.getId()));

        System.out.println("datacenter0 host0 VMs");
        System.out.println(datacenter0.getHostList().get(0).getVmList());;
        System.out.println("datacenter1 host0 VMs");
        datacenter1.getHostList().get(0).getVmList().forEach(v-> System.out.println(v.getId()));
