 ...
 */
public class HeuristicSimulationKTH_0 {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        new HeuristicSimulationKTH_0();
    }

    private HeuristicSimulationKTH_0() throws IOException, ParseException {
        ...
        for (int generations = 0; generations < 1; generations++) {
            ...
            mh_ga.removeWeakChromosomes(fitnessList, candidateList, "max", 1);
