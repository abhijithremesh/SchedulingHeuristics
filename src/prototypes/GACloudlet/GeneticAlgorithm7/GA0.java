...
public class GA0 {
                ...
                if (mutationProb > givenMutationRate) {
                    ...
                    switch (mutationType) {
                        case 0:
                            ...
                            childChromosome = mutateSwap(childChromosome);
                            break;
                        case 1:
    ...
    private double getTotalExecutionTime(List<Cloudlet> finishedCloudlets){
    ...
    private double getTotalFlowTime(List<Cloudlet> finishedCloudlets){
    ...
    private double getAverageExecutionTime(List<Cloudlet> finishedCloudlets){
    ...
    private double getAverageWaitingTime(List<Cloudlet> finishedCloudlets){
    ...
    private double getAverageFlowTime(List<Cloudlet> finishedCloudlets){
    ...
    public double calculateFitnessFunctionOne(DatacenterBroker broker){

        List<Cloudlet> finishedCloudlets = broker.getCloudletFinishedList();
        double fitnessValue = getTotalFinishTime(finishedCloudlets) + getTotalWaitingTime(finishedCloudlets) +
            getTotalExecutionTime(finishedCloudlets) + getTotalFlowTime(finishedCloudlets);
    ...
    public double calculateFitnessFunctionTwo(DatacenterBroker broker){

        List<Cloudlet> finishedCloudlets = broker.getCloudletFinishedList();
        double fitnessValue = getTotalFinishTime(finishedCloudlets) + getTotalWaitingTime(finishedCloudlets) +
            getTotalExecutionTime(finishedCloudlets);
    ...
    public double calculateFitnessFunctionThree(DatacenterBroker broker){

        List<Cloudlet> finishedCloudlets = broker.getCloudletFinishedList();
        double fitnessValue = getTotalFinishTime(finishedCloudlets) + getAverageWaitingTime(finishedCloudlets) +
            getAverageExecutionTime(finishedCloudlets) + getAverageFlowTime(finishedCloudlets);
    ...
    public double calculateFitnessFunctionFour(DatacenterBroker broker){
        ...
        //double fitnessValue =  getAverageWaitingTime(finishedCloudlets) + getAverageExecutionTime(finishedCloudlets);
        fitnessValue = Math.round(fitnessValue * 100.0) / 100.0;
