...
public class SufferageCheckSpaceShared2 {
    ...
    public static void main(String[] args) {
        new SufferageCheckSpaceShared2();
    }

    private SufferageCheckSpaceShared2() {
        ...
        cloudletList = createCloudletsFromWorkloadFile(1000);
