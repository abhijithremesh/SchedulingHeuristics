...
public class InfraGreenBestCandidateRun {
    ...
    private int maximumNumberOfCloudletsToCreateFromTheWorkloadFile = 200;
    ...
    ArrayList<Integer> solutionCandidate = new ArrayList<>(Arrays.asList(4, 6, 9, 8, 5, 3, 0, 7, 5, 9, 8, 9, 6, 7, 3, 1, 5, 2, 0, 4, 1, 2, 6, 2));
