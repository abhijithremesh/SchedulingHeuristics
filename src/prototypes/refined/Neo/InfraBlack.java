...
public class InfraBlack {
    ...
    private int maximumNumberOfCloudletsToCreateFromTheWorkloadFile = 200; // Integer.MAX_VALUE
    ...
    private InfraBlack() {
        ...
        //simulation.addOnEventProcessingListener();
    ...
    private List<Cloudlet> createCloudletsFromWorkloadFile() {
        ...
        SwfWorkloadFileReader reader = SwfWorkloadFileReader.getInstance(WORKLOAD_FILENAME, 10);
        reader.setMaxLinesToRead(maximumNumberOfCloudletsToCreateFromTheWorkloadFile);
        this.cloudletList = reader.generateWorkload();
        //cloudletList.forEach(c->c.setUtilizationModel(utilizationModel));
