...
public class LongestCloudletFastestProcessingElementCheck {

    List<Cloudlet> cloudletList;
    List<Vm> vmList;
    CheckBroker brokercheck;

    LongestCloudletFastestProcessingElementCheck (List<Cloudlet> cloudletList,List<Vm> vmList, CheckBroker brokercheck){
