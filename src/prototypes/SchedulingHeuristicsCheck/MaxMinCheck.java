...
public class MaxMinCheck {
    ...
    MaxMinCheck (List<Cloudlet>cloudletList, List<Vm> vmList, CheckBroker brokercheck){
    ...
    public void MaxMinChecking(){
        ...
        for(int c=0; c< clist.size(); c++) {
            ...
            brokercheck.bindCloudletToVm(maximumCloudlet, minimumVm);
