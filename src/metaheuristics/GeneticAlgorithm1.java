...
public class GeneticAlgorithm1 {
    ...
    private GeneticAlgorithm1() {
        ...
        //FirstComeFirstServeBroker broker0 = new FirstComeFirstServeBroker(simulation);
        ...
        //for ( ArrayList<Integer> c : chromosomeList) {
        ...
        System.out.println("Running the algorithm for 20 generations");
        ...
        for(int count=1;count<=generation;count++) {
            ...
            System.out.println("Fittest Chromosome of Generation "+count+" is having makespan of "+ Collections.min(fitnessList));
            ...
            System.out.println("Index of Fittest Chromosome of Generation "+count+" is "+ indexofFittestChromosome);
            ...
            if(count<generation) {
                ...
                // Creating offsprings and a container to store the offsprings
                ...
                //System.out.println("offspringList: "+ offspringList);
                ...
                System.out.println("Size of chromosomeList: "+ chromosomeList.size());
        ...
        // broker0.scheduleTaskstoVms(cloudletList,vmList);


        simulation.start();

        //System.out.println("Vm list: "+vmList);
        ...
        //    System.out.println("Cloudlet-"+cl.getId());
        //}
    ...
    private static double calculateFitness(ArrayList<Integer> chromosome,int vmCount,List<Cloudlet> cloudletList ,double filesize,int pe,int mips,int bw) {
       ...
       // System.out.print(cloudletList.get(item).getId());
