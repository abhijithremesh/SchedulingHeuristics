...
public class MinMin {
    ...
    private MinMin(){
        ...
        MinMinBroker2 broker0 = new MinMinBroker2(simulation);
    ...
    private List<Vm> createVms(MinMinBroker2 broker0) {
    ...
    private List<Cloudlet> createCloudlets(MinMinBroker2 broker0) {
