...
public class ShortestJobFirst4 {
    ...
    public static void main(String[] args) {
        new ShortestJobFirst4();
    }

    private ShortestJobFirst4(){

        simulation = new CloudSim();
        datacenter0 = createDatacenter();

        ShortestJobFirstBroker4 broker0 = new ShortestJobFirstBroker4(simulation);
        ...
        cloudletList = broker0.scheduleTasksToVms(vmList,cloudletList);
    ...
    private List<Vm> createVms(ShortestJobFirstBroker4 broker0) {
    ...
    private List<Cloudlet> createCloudlets(ShortestJobFirstBroker4 broker0) {
