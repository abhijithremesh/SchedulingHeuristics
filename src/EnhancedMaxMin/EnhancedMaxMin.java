...
public class EnhancedMaxMin {
    ...
    private EnhancedMaxMin(){

        simulation = new CloudSim();
        datacenter0 = createDatacenter();

        EnhancedMaxMinBroker broker0 = new EnhancedMaxMinBroker(simulation);
    ...
    private List<Vm> createVms(EnhancedMaxMinBroker broker0) {
    ...
    private List<Cloudlet> createCloudlets(EnhancedMaxMinBroker broker0) {
