...
public class Sufferage {
    ...
    private Sufferage(){
        ...
        SufferageBroker broker0 = new SufferageBroker(simulation);
    ...
    private List<Vm> createVms(SufferageBroker broker0) {
    ...
    private List<Cloudlet> createCloudlets(SufferageBroker broker0) {
