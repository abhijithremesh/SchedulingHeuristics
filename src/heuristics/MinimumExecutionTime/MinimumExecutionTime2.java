...
public class MinimumExecutionTime2 {
    ...
    public static void main(String[] args) {
        new MinimumExecutionTime2();
    }

    private MinimumExecutionTime2(){

        simulation = new CloudSim();
        datacenter0 = createDatacenter();

        MinimumExecutionTimeBroker2 broker0 = new MinimumExecutionTimeBroker2(simulation);
    ...
    private List<Vm> createVms(MinimumExecutionTimeBroker2 broker0) {
    ...
    private List<Cloudlet> createCloudlets(MinimumExecutionTimeBroker2 broker0) {
