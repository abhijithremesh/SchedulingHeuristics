...
public class LCFP1 {
    ...
    private LCFP1() {
        ...
        LCFPBroker1 broker0 = new LCFPBroker1(simulation);
    ...
    private List<Vm> createVms(LCFPBroker1 broker0) {
    ...
    private List<Cloudlet> createCloudlets(LCFPBroker1 broker0) {
