...
public class Random {
    ...
    private Random(){
        ...
        RandomBroker broker0 = new RandomBroker(simulation);
    ...
    private List<Vm> createVms(RandomBroker broker0) {
    ...
    private List<Cloudlet> createCloudlets(RandomBroker broker0) {
