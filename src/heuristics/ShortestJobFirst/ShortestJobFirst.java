...
public class ShortestJobFirst {
    ...
    private ShortestJobFirst(){
        ...
        ShortestJobFirstBroker broker0 = new ShortestJobFirstBroker(simulation);

        vmList = createVms(broker0);
        cloudletList = createCloudlets(broker0);

        cloudletList = broker0.OrderShortestJobFirst(cloudletList);
    ...
    private List<Vm> createVms(ShortestJobFirstBroker broker0) {
    ...
    private List<Cloudlet> createCloudlets(ShortestJobFirstBroker broker0) {
