...
public class GeneralizedPriority1 {
    ...
    public static void main(String[] args) {
        new GeneralizedPriority1();
    }

    private GeneralizedPriority1() {

        simulation = new CloudSim();
        datacenter0 = createDatacenter();

        GeneralizedPriorityBroker1 broker0 = new GeneralizedPriorityBroker1(simulation);
    ...
    private List<Vm> createVms(GeneralizedPriorityBroker1 broker0) {
    ...
    private List<Cloudlet> createCloudlets(GeneralizedPriorityBroker1 broker0) {
