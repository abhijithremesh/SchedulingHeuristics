...
public class MinimumExecutionTime {
    ...
    private MinimumExecutionTime(){
        ...
        MinimumExecutionTimeBroker broker0 = new MinimumExecutionTimeBroker(simulation);
    ...
    private List<Vm> createVms(MinimumExecutionTimeBroker broker0) {
    ...
    private List<Cloudlet> createCloudlets(MinimumExecutionTimeBroker broker0) {
