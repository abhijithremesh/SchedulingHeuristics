...
public class SufferageBroker extends DatacenterBrokerSimple {

    public SufferageBroker(final CloudSim simulation) {
        super(simulation);
    }
    ...
    public void scheduleTasksToVms(List<Vm> vmList, List<Cloudlet> cloudletList ) {
        ...
        for(int c=0; c< clist.size(); c++) {
            ...
            bindCloudletToVm(maximumsufferageCloudlet, minimumVm);
